            ...
            <div className="flex px-3 flex-col lg:flex-row justify-center gap-x-3 mx-auto mt-5 mb-10">
                ...
                <div className="bg-white p-4 rounded border border-[#2ACB35] m-3">
                  ...
                  {activeIndex === 1 && (
                    <p>
                      ...
                      সমন্বয়ে গঠিত বক্সটিকে ফাস্ট এইড বক্স বলে। এটি যেকোনো
              ...
              <div className="flex-1 w-full">
                ...
                <div className="bg-white p-4 rounded border border-[#2ACB35] m-3 cursor-pointer">
                  ...
                  {activeIndex === 6 && (
                    <p>
                      আমরা চাই প্রতিটি অর্ডার নিশ্চিত হোক এবং আপনার হাতে
                      প্রোডাক্টটি পৌঁছে যাক নিরাপদভাবে ও সময়মতো। এই ২০০ টাকা
                      অগ্রিম পেমেন্ট মূলত অর্ডার কনফার্মেশন ও ডেলিভারি
                      প্রসেসিংয়ের জন্য নেওয়া হয়, যাতে আমরা নিশ্চিত হতে পারি যে
                      অর্ডারটি আসলেই গ্রহণযোগ্য ও সত্যিকারের। এতে আমাদের সার্ভিস
                      আরও দ্রুত এবং নির্ভরযোগ্য হয়।
                    </p>
                  )}
                </div>
              </div>
