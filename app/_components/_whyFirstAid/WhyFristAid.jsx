   ...
   const  whyFirstAidData = [
    {
        ...
        description:"রক্তক্ষরন বন্ধে জন্য ফার্স্ট এইড বক্স থাকলে বিপদের সময় বিচলিত হতে হয়না।"
    },
    {
        icon:"https://i.postimg.cc/vHtgJgmD/5875818-blood-cell-disease-infect-lab-icon-1.png",
        heading:"ঘা-পাঁচড়া শুকানোর জন্য",
        description:"অনেক সময় ঔষধের চেয়ে জীবানুনাশক কিছু দিয়ে প্রাথমিক চিকিৎসায় ঘা-পাচড়া ভাল হয়।"
    },
    {
        ...
        description:"প্রাথমিক পর্যায়ে সর্দি-কাশির চিকিৎসা করা যাবে একটি ফার্স্ট এইড বক্স থাকলে।"
    },
    {
        icon:"https://i.postimg.cc/YqHLDfMJ/5859949-accident-foot-injury-leg-pain-icon-1.png",
        heading:"বড় বিপদ এড়ানোর জন্য",
        description:"অনেক সময় অনেক বড় বিপদের হাত থেকে রক্ষা পাবেন একটি বক্স থাকলে।"
    },
    {
        ...
        description:"জরুরী পরিস্থিতিতে অনেক সময় একটা ফার্স্ট এইড বক্স জীবন রক্ষা করতে পারে।"
    },
    {
        icon:"https://i.postimg.cc/7P7TNQ83/6088629-bacteria-find-germs-scan-search-icon-1.png",
        heading:"জীবাণু প্রতিরোধের জন্য",
        description:"জীবাণু প্রতিরোধে অনেক সময় কিছুই থাকেনা ঘরে। এক্ষেত্রে বক্সটি অনেক উপকারী।"
    },
    ...
    return (
        <div className="py-[50px] md:py-[90px] bg-lime">
         <Container>
            <h1 className='text-[40px] md:text-[60px] lg:text-[80px]  font-bold pb-[20px] md:pb-[40px]'>কেনো ফার্স্ট এইড বক্স <br /> প্রয়োজন?</h1>
